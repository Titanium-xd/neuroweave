"""
scripts/tasks/run_campaign_t002.py — Second real ABB experiment campaign.
...
def main():
    ...
    parser.add_argument("--save-dir", type=str, default="artifacts/campaign_2")
    ...
    print("=" * 64)
    print("  ABB EXPERIMENT CAMPAIGN (T-002 Temporal Sequence Memory)")
    print("=" * 64)
    ...
    architectures = [
        "A0 Random", "A1-BIO", "A1-FROZEN", "A7-MLP", "A8-LSTM"
    ]
    ...
    # Print summary table
    print("\n" + "=" * 80)
    print("  T-002 EXPERIMENT CAMPAIGN SUMMARY")
    print("=" * 80)
    ...
    try:
        ...
        ax.set_title("T-002: Temporal Sequence Memory (5 Seeds, 95% CI)")
        ax.set_xticks(x)
        ...
        plt.tight_layout()
        plot_path = out_dir / "campaign_2_results.png"
